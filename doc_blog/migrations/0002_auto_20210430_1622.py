...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='post',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='doc_blog.category', verbose_name='分类'),
        ),
        migrations.AlterField(
            model_name='post',
            name='create_time',
        ...
        migrations.AlterField(
            model_name='post',
            name='tags',
            field=models.ManyToManyField(blank=True, to='doc_blog.Tag', verbose_name='标签'),
        ),
    ]
